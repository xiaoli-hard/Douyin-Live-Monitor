...
class RealDataDynamicBaseline:
    ...
    def __init__(self, data_dir: str = "./数据存储"):
        ...
        self.absolute_indicators = [
            '消耗', '画面-消耗', '视频-消耗', '调控消耗', '整体GMV', '画面-gmv', 
            '视频-gmv', '调控GMV', '整体GSV', '成交人数', '平均在线', '在线峰值', 
            '观看人数', '直播间曝光人数', '直播间进入人数', '商品曝光人数', '商品点击人数', 
            '成交件数', '大瓶装订单数', '三瓶装订单数', '调控成交订单数', '画面-曝光数', 
            '画面-点击数', '画面-转化数', '视频-曝光数', '视频-点击数', '视频-转化数', 
            '直播间曝光次数', '直播间观看次数', '智能优惠劵金额', '退款金额', '引流成本', 
            '转化成本', '整体uv价值', 'GPM', '人均观看时长'
        ]
        self.ratio_indicators = [
            '整体ROI', '实际ROI', '画面-roi', '视频-roi', '调控ROI', '画面-消耗占比', 
            '视频-消耗占比', '调控-消耗占比', '点击转化率', '画面-CTR', '画面-CVR', 
            '视频-CTR', '视频-CVR', '曝光进入率', '商品-曝光率', '商品点击率', 
            '客单价', '转化率'
            # 移除重复指标: '直播间曝光人数_1', '成交人数_1'
        ]
